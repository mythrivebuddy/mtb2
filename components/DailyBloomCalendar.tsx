...
//         <span
//           className={`truncate font-medium max-w-[70%] text-xs sm:text-sm transition-all duration-200 ${isCompleted
...
//                   onClick={() => toggleFilter("bloom")}
//                   variant={activeFilters.includes("bloom") ? "default" : "ghost"}
//                   className={`text-xs sm:text-sm h-9 px-4 rounded-xl transition-all duration-200 ${activeFilters.includes("bloom")
...
//                   onClick={() => toggleFilter("custom")}
//                   variant={activeFilters.includes("custom") ? "default" : "ghost"}
//                   className={`text-xs sm:text-sm h-9 px-4 rounded-xl transition-all duration-200 ${activeFilters.includes("custom")
