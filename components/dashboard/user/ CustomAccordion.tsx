...
const allAccordionData = [
  {
    ...
    content: (
      <>
        <p className="mb-4">
          Establish a clear plan for your day, turning your ambitions into a
          sequence of concrete actions you can tackle one by one.
        </p>
        <ul className="list-disc pl-1 ">
          <li>
            Makes big goals less intimidating by breaking them into manageable
            daily steps.
          </li>
          <li>
            Frees up your mental energy by capturing priorities, so you can
            focus on execution.
          </li>
          <li>
            Creates a positive feedback loop of success that builds confidence
            and momentum.
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          Document unexpected breakthroughs and lucky moments to build belief
          and track unseen progress.
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          Log your tiny daily actions — the pebble moves — that add up to real
          growth.
        </p>
        <ul className="list-disc pl-5 ">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          Helps you start a tiny action instantly — even just 1% — to build
          momentum.
        </p>
        <ul className="list-disc pl-5">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          A rotating Spotlight feature that showcases one solopreneur to the
    ...
    content: (
      <>
        <p className="text-gray-700 mb-4">
          Create your own personal challenges or join public ones to build
          discipline, test your limits, and achieve goals alongside the
          community.
        </p><ul className="list-disc pl-5 ">
          <li>
            Boosts motivation and accountability through shared goals and
            friendly competition.
          </li>
          <li>
            Provides a structured way to build new habits and skills in a
            supportive environment.
          </li>
          <li>
            Fosters connection and collaboration by allowing you to engage with
            other members&rsquo; journeys.
          </li>
        </ul>
      </>
    ),
...
export default function CustomAccordion() {
  ...
  else if (pathname.includes("aligned-actions"))
    selectedType = "1_percent_start";
  ...
  else if (pathname.includes("challenge")) selectedType = "challenges";

  const filteredData = allAccordionData.filter(
    ...
    <div className="max-lg:px-4 mx-auto max-w-4xl">
      {filteredData.map((item, index) => {
        ...
        return (
          <div
            key={index}
            className="w-full border border-green-700 rounded-lg bg-green-100 mb-4 overflow-hidden"
          >
            <button
