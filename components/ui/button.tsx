  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        mtbPrimary: " bg-[var(--brand-deep)] text-[var(--ink-inverse)] hover:bg-[var(--brand-deep-hover)] shadow-md",
        mtbOutline: "border-2 border-[var(--border-accent)] text-[var(--ink-accent)] bg-transparent hover:bg-[var(--surface-calm)]",
        mtbTertiary:"border border-[var(--border-ink)]",
        mtbGhost: "text-[var(--ink-primary)] hover:text-[var(--ink-accent)] hover:bg-[var(--surface-soft)]",
      },
      size: {
        ...
        icon: "h-10 w-10",
        mtbPill: "h-12 px-8 rounded-full text-base",
      },
    },
    defaultVariants: {
      variant: "default",
