    ...
    <div className="relative">
      <div className="flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center space-x-2">
          ...
          />
          <span className="font-semibold text-lg sm:text-[22px] text-[#1E2875]">MyThriveBuddy.com</span>
          <span className="text-[10px] sm:text-[12px] font-medium px-1.5 sm:px-2 py-0.5 bg-black text-white rounded">BETA</span>
        </Link>

        {/* Desktop Navigation */}
        <div className="hidden md:flex items-center space-x-4 lg:space-x-8">
          <Link href="/blog" className="text-[#333333] hover:text-[#1E2875] text-[16px]">
            Blog
          </Link>
          <Link href="/contact" className="text-[#333333] hover:text-[#1E2875] text-[16px]">
            Contact Us
          </Link>
