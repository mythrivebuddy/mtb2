...
export default function Share({ url, title, buttonLabel = "Share" }: ShareProps) {
  ...
  const modal = (
    ...
    >
      ...
      >
        ...
        <p className="text-sm font-semibold text-slate-500 mb-3">Share link via</p>
  ...
  return (
    <>
      <button
        ...
        className={theme.buttonLight + " flex items-center gap-2 px-3 py-1.5  text-white rounded-full text-sm font-semibold  transition-colors"}
      >
