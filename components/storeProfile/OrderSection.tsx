              ...
              >
                <div className="flex justify-between items-start gap-4 mb-4">
                  ...
                  <div className="text-right">
                    <p
                      className={`text-xs font-semibold px-3 py-1 rounded-full bg-gray-100 ${getStatusColor(
                        order.status
                      )}`}
                    >
                    ...
                    <p
                      className={`font-bold text-xl mt-2 ${
                        isPointsOrder ? "text-purple-600" : "text-green-600"
                      }`}
                    >
                ...
                <div className="space-y-3 border-t border-gray-200 pt-4">
                  {order.items.map((orderItem) => {
                    ...
                    return (
                      <div
                        key={orderItem.id}
                        className="flex items-center gap-4 bg-gray-50 border border-gray-100 p-3 rounded-xl hover:bg-gray-100 transition"
                      >
                        ...
                        {downloadUrl ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white text-xs font-semibold px-3 py-2 rounded-lg transition shadow-sm"
                          >
