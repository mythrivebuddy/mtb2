...
function parseSocial(val: unknown): typeof EMPTY_SOCIAL {
  ...
  if (typeof v === "string") {
    try {
      return { ...EMPTY_SOCIAL, ...JSON.parse(v) };
    } catch {
      return EMPTY_SOCIAL;
    }
  }
...
export default function UserPublicProfile({ userId, userData }: Props) {
  ...
  if (
    status === "loading" &&
    (userData.userType === "COACH" || userData.userType === "SOLOPRENEUR")
  ) {
  ...
  if (isBusinessUser && !showPersonalProfile) {
    return (
      <ProfileMain profile={mapToBusinessProfile(userData)} userId={userId} />
    );
  }
  return (
            ...
            <CardHeader className="pt-28">
              <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                <div className="space-y-3">
                  <h1 className="text-5xl font-bold text-gray-800 tracking-tight pb-2">
                    {safe.name}
                  </h1>
                    ...
                    >
                      <DropdownMenuItem asChild>
                        <button
                          ...
                          className="w-full h-11 flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-md"
                        >
                          <Link className="h-5 w-5 text-blue-600" /> Copy
                          Profile Link
                        </button>
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild>
                      ...
                      <DropdownMenuItem asChild>
                        <a
                          href={`https://t.me/share/url?url=${profileUrl}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-full"
                        >
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <div className="flex gap-4">
                  {safe.handles.facebook && (
                    <a
                      href={safe.handles.facebook}
                      target="_blank"
                      rel="noreferrer"
                    >
                      <Button
                        variant="outline"
                        className="p-3 rounded-full border-gray-200 bg-white/50 hover:bg-blue-50 shadow-sm"
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <DialogContent className="w-[90vw] max-w-sm bg-white rounded-2xl p-6 shadow-xl border">
                      ...
                      <div className="pt-6 flex justify-center">
                        <div className="flex flex-col items-center p-8 w-full max-w-xs bg-gradient-to-br from-yellow-50 to-amber-100 rounded-xl border border-amber-200/50">
                          <p className="text-base font-medium text-amber-900 mb-3">
                            Total Miracles Logged
                          </p>
                ...
                {isDesktop ? (
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="w-[90vw] max-w-lg bg-white rounded-2xl p-6 shadow-xl border">
                      <DialogHeader>
                        <DialogTitle className="text-center pb-6 text-2xl font-bold text-gray-800">
                          Challenges Status
                        </DialogTitle>
                      </DialogHeader>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    <CardHeader>
                      <h3 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
                        <Briefcase className="h-5 w-5 text-blue-600" /> Key
                        Offerings
                      </h3>
                    </CardHeader>
                    <CardContent>
                ...
                {safe.featuredWorkTitle && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    <CardHeader>
                      <h3 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
                        <FileText className="h-5 w-5 text-blue-600" /> Featured
                        Work Title
                      </h3>
                    </CardHeader>
                    <CardContent>
