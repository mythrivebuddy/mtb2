  ...
  const topics = [
    {
      ...
      label: "Newsletters & Content Strategy",
    },
    { icon: <DollarSign className="w-5 h-5" />, label: "Pricing & Offers" },
    {
      icon: <Settings className="w-5 h-5" />,
      label: "Tools, Systems & Platforms",
    },
    {
      icon: <AlarmClock className="w-5 h-5" />,
      label: "Time Management & Burnout",
    },
    {
      icon: <Users className="w-5 h-5" />,
      label: "Niche Positioning & Ideal Clients",
    },
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          <h1 className="text-3xl lg:text-5xl font-bold text-gray-900 leading-tight">
            What If 10,000 Solopreneurs Answered Every Business Question You’ve
            Ever Had?
          </h1>

          <p className="text-gray-700 text-base">
            You’re invited to co-create the world’s largest solopreneur
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-start gap-2 text-green-600">
          <Check className="w-12 h-12  sm:h-5 sm:w-5 mt-1" />


              <span>
                Help unlock a data vault that will change how solopreneurs make
                decisions.
              </span>
            </li>
          </ul>
          ...
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
                ...
                <li>
                  How pricing, offers, and niche positioning are actually
                  working
                </li>
                <li>
                  What habits, beliefs, and patterns high-performing
                  solopreneurs share
                </li>
              </ul>
          ...
          <div className="mt-8">
            <h3 className="font-semibold text-gray-800">
              The Insight Vault is Sealed for Now
            </h3>
            <p className="text-sm text-gray-700">
              We’re not showing a single graph until we hit 10,000 contributors.
              Because this isn’t about shortcuts — it’s about truth, powered by
              numbers. The more solopreneurs contribute, the clearer the picture
              becomes.
            </p>
          </div>
          ...
          <div className="text-sm text-gray-500 mt-6">
            ...
            <br />
            Share this survey with fellow solopreneurs and let’s unlock the data
            vault together!
          </div>
        </div>
      </div>
