...
export default function BusinessProfileLayout() {
  ...
  if (status === "loading")
    return (
      <div className="h-[700px] py-16 flex justify-center items-center bg-slate-50 dark:bg-slate-950">
        <Loader2 className="animate-spin w-12 h-12 text-indigo-600 dark:text-indigo-400" />
      </div>
    );

  if (!session) {
    return (
      <div className="p-6 text-center bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200">
  ...
  if (!profileLoaded)
    return (
      <div className="h-[700px] py-16 flex justify-center items-center">
  ...
  return (
    <FormProvider {...methods}>
      <div className="max-w-8xl mx-auto p-6 bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200">
