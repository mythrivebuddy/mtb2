        ...
        <section className="flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full md:w-96 bg-white rounded-3xl p-8 shadow-xl border sticky top-10 space-y-6">
            ...
            <button
              ...
              className="w-full bg-gray-100 hover:bg-gray-200 py-3 rounded-xl font-medium transition"
            >
              Connect With Me
            </button>
          ...
          {profile.servicesOffered?.length ? (
            <div className="grid md:grid-cols-3 gap-6">
              {profile.servicesOffered.slice(0, 3).map((service, i) => (
                <div
                  key={i}
                  className={`p-8 rounded-3xl border shadow-sm ${i === 1 ? "border-blue-500 shadow-lg" : "bg-white"}`}
                >
                  {i === 1 && (
              ...
              {profile.testimonials.map((t, i) => (
                ...
                >
                  <p className="text-gray-600 text-sm leading-relaxed">
                    <RiDoubleQuotesL className="inline mr-1 -translate-y-1" />
                    {t.content}
                    <RiDoubleQuotesR className="inline ml-1 -translate-y-1" />
                  </p>
