...
const featureConfig = {
    ...
    plans: {
      free: {
        COACH: {
          ...
          groupChatLimit: -1,
          joinLimit: -1,
          limitType: "LIFETIME" as LimitType,
  ...
  store: {
    ...
    plans: {
      free: {
        COACH: { commissionPercent: 15 },
      },
      paid: {
        COACH: { commissionPercent: 5 },
      },
    },
  },
};
...
const FEATURE_SCHEMAS: Record<string, Record<string, SchemaField>> = {
  ...
  dailyBlooms: {
    dailyLimit: {
      type: "number",
      label: "Daily Limit (-1 unlimited)",
      default: 3,
      nullable: true,
    },
    canCreateRecurringBlooms: {
      type: "boolean",
      label: "Recurring Blooms",
      default: false,
      nullable: true,
    },
  },
  ...
  challenges: {
    ...
    canCreatePaidChallenge: {
      type: "boolean",
      label: "Paid Challenge",
      default: false,
      nullable: true,
    },
    commissionPercent: {
