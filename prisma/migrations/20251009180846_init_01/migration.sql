...
-- CreateEnum
CREATE TYPE "public"."Visibility" AS ENUM ('PUBLIC', 'PRIVATE', 'MEMBERS_CAN_SEE_GOALS');
...
-- CreateEnum
CREATE TYPE "public"."ActivityFeedType" AS ENUM ('GOAL_CREATED', 'GOAL_COMPLETED', 'COMMENT_ADDED', 'USER_JOINED_GROUP', 'CYCLE_STARTED', 'CYCLE_ENDED', 'GROUP_CREATED', 'GOAL_UPDATED', 'STATUS_UPDATED');
...
CREATE TABLE "public"."Group" (
    ...
    "creatorId" TEXT NOT NULL,
    "coachId" TEXT,
    "progressStage" "public"."ProgressStage" NOT NULL DEFAULT 'NOT_STARTED',
    "notesPrivacy" "public"."NotesPrivacy" NOT NULL DEFAULT 'VISIBLE_TO_GROUP',
    "cycleDuration" "public"."CycleDuration" NOT NULL DEFAULT 'WEEKLY',
...
CREATE TABLE "public"."Goal" (
    ...
    "stage" "public"."ProgressStage" NOT NULL DEFAULT 'NOT_STARTED',
...
-- CreateTable
CREATE TABLE "public"."_GoalToGroup" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_GoalToGroup_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "public"."_GoalToUser" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "Reward_adminId_idx" ON "public"."Reward"("adminId");

-- CreateIndex
CREATE INDEX "Reward_memberId_idx" ON "public"."Reward"("memberId");

-- CreateIndex
CREATE INDEX "Reward_cycleId_idx" ON "public"."Reward"("cycleId");

-- CreateIndex
CREATE INDEX "_BuddyLensReviews_B_index" ON "public"."_BuddyLensReviews"("B");

-- CreateIndex
CREATE INDEX "_GoalToGroup_B_index" ON "public"."_GoalToGroup"("B");

-- CreateIndex
CREATE INDEX "_GoalToUser_B_index" ON "public"."_GoalToUser"("B");
...
-- AddForeignKey
ALTER TABLE "public"."Goal" ADD CONSTRAINT "Goal_authorId_groupId_fkey" FOREIGN KEY ("authorId", "groupId") REFERENCES "public"."GroupMember"("userId", "groupId") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Reward" ADD CONSTRAINT "Reward_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Reward" ADD CONSTRAINT "Reward_memberId_fkey" FOREIGN KEY ("memberId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Reward" ADD CONSTRAINT "Reward_cycleId_fkey" FOREIGN KEY ("cycleId") REFERENCES "public"."Cycle"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."_GoalToGroup" ADD CONSTRAINT "_GoalToGroup_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Goal"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_GoalToGroup" ADD CONSTRAINT "_GoalToGroup_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_GoalToUser" ADD CONSTRAINT "_GoalToUser_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Goal"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_GoalToUser" ADD CONSTRAINT "_GoalToUser_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
