...
export interface CertificatePDFProps {
  ...
  signatureType?: "IMAGE" | "TEXT" | "DRAWN";
  certificateId: string;
  qrCodeDataUrl: string;
}

const TEMPLATE_URL = `${process.env.NEXT_PUBLIC_BASE_URL}/certificate-template-placeholder.png`;
...
const styles = StyleSheet.create({
  ...
  signature: {
    position: "absolute",
    bottom: 250, // signature ABOVE the line
    left: 320,
    width: 180,
    height: 100,
    objectFit: "contain",
