  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        {/* <Button
          onClick={() => router.back()}
          className="mb-8 bg-white text-gray-800 hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 flex items-center gap-2 px-4 py-2 rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
        >
          <ArrowLeft className="h-5 w-5" />
          Back
        </Button> */}
            ...
            <CardHeader className="pt-28">
              <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                <div className="space-y-3">
                  <h1 className="text-5xl font-bold text-gray-800 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">{userData.name}</h1>
                  {userData.bio && (
            ...
            <CardContent className="space-y-12">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <div className="flex gap-4">
                  {userData.socialHandles.facebook && (
                    <a href={userData.socialHandles.facebook} target="_blank" rel="noreferrer">
                      <Button variant="outline" className="p-3 rounded-full border-gray-200 bg-white/50 hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 shadow-sm hover:shadow-md transition-all duration-300">
                        <Facebook className="h-6 w-6 text-blue-600" />
                      </Button>
                    </a>
                  )}
                  {userData.socialHandles.x && (
                    <a href={userData.socialHandles.x} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" className="p-3 rounded-full border-gray-200 bg-white/50 hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  {userData.socialHandles.youtube && (
                    <a href={userData.socialHandles.youtube} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" className="p-3 rounded-full border-gray-200 bg-white/50 hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  {userData.socialHandles.tiktok && (
                    <a href={userData.socialHandles.tiktok} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" className="p-3 rounded-full border-gray-200 bg-white/50 hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Badge className="py-3 md:px-6 text-sm bg-gradient-to-r from-indigo-100 to-blue-100 text-indigo-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex-wrap">
                  <span className="font-semibold">Balance:</span> {userData.jpBalance} JP
                </Badge>
                <Badge className="py-3 md:px-6 text-sm bg-gradient-to-r from-green-100 to-teal-100 text-green-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex-wrap">
                  <span className="font-semibold">Earned:</span> {userData.jpEarned} JP
                </Badge>
                <Badge className="py-3 md:px-6 text-sm bg-gradient-to-r from-amber-100 to-yellow-100 text-amber-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex-wrap">
                  <span className="font-semibold">Spent:</span> {userData.jpSpent} JP
                </Badge>
                <Badge className="py-3 md:px-6 text-sm bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex-wrap">
                  <span className="font-semibold">Transactions:</span> {userData.jpTransaction}
                </Badge>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {userData.keyOfferings && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600 leading-relaxed">{userData.keyOfferings}</p>
                    </CardContent>
                  </Card>
                )}
                {userData.achievements && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600 leading-relaxed">{userData.achievements}</p>
                    </CardContent>
                  </Card>
                )}
                {userData.missionStatement && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600 leading-relaxed">{userData.missionStatement}</p>
                    </CardContent>
                  </Card>
                )}
                {userData.goals && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600 leading-relaxed">{userData.goals}</p>
                    </CardContent>
                  </Card>
                )}
                {userData.featuredWorkTitle && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600 leading-relaxed">{userData.featuredWorkTitle}</p>
                    </CardContent>
                  </Card>
                )}
                {userData.featuredWorkDesc && (
                  <Card className="bg-white/50 backdrop-blur-md shadow-md rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300">
                    ...
                    <CardContent>
                      <p className="text-gray-600 leading-relaxed">{userData.featuredWorkDesc}</p>
                    </CardContent>
                  </Card>
                )}
              </div>
