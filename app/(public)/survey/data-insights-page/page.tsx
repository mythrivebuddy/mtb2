...
export default function Dashboard() {
  ...
  return (
    ...
    <main className="max-w-5xl mx-auto py-12 px-4">
      <h1 className="text-2xl font-bold mb-8">Here’s what solopreneurs like you are doing</h1>
      {/* Filters */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <Card>
          ...
          <CardContent>
            {/* Dummy bar chart (replace with real Chart.js or Visx component if needed) */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardContent className="flex flex-col items-center justify-center p-0 h-48 bg-green-100">
            {/* Replace below with actual image as needed */}
