      ...
      <div className="min-h-screen font-sans">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 bg-white px-3 py-6 rounded-2xl shadow-sm self-start">
                  ...
                  {challenge.leaderboard?.map((player, index) => (
                    <li key={player.id}>
                      <div
                        ...
                        className="flex justify-between items-start hover:bg-gray-100 rounded-lg py-4 px-2 min-h-[60px]"
                      >
                        <Link   
  ...
  <DialogContent className="sm:max-w-md">
    <DialogHeader>
      ...
      <DialogDescription>
        ...
        <strong>{selectedUser?.name}</strong> from this challenge.  
