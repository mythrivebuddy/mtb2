        ...
        <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
          <div className="flex gap-2 flex-wrap">
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-bold transition-all ${filterStatus === "all"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-bold transition-all ${filterStatus === "approved"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-bold transition-all ${filterStatus === "not-approved"
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg max-h-[80vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium">
                    Image File {editingItem && "(Optional - leave empty to keep current)"}
                  </label>
                  <input
                    type="file"
                    accept="image/*"
