                    ...
                    <div className="flex items-center justify-between gap-4 flex-wrap">
                        ...
                        <div>
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            <span className={`inline-flex items-center gap-1 text-xs font-bold px-2 py-1 rounded-full ${
                              ...
                              {orderCurrency === "INR" ? <RupeeIcon className="w-3 h-3" /> : <DollarIcon className="w-3 h-3" />}
                              {orderCurrency}
                            </span>
                          </div>
                          <div className="flex items-center gap-4 text-sm text-slate-600">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <div className="text-xs text-slate-500 mb-0.5">Total Amount</div>
                          <div className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                            {orderSymbol}{order.totalAmount.toFixed(2)}
                          </div>
                        </div>
                        <div className="p-2">
                          {isExpanded ? (
                      ...
                      <div className="p-6">
                            ...
                            return (
                              ...
                              >
                                <div className="w-20 h-20 rounded-xl overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 flex-shrink-0 relative">
                                  ...
                                  {wasConverted && (
                                    <span className={`absolute -top-1 -left-1 inline-flex items-center gap-0.5 text-[10px] font-bold px-1.5 py-0.5 rounded-full ${
                                      ...
                                      {orderItem.originalCurrency === "INR" ? <RupeeIcon className="w-2 h-2" /> : <DollarIcon className="w-2 h-2" />}
                                  ...
                                  {wasConverted && orderItem.originalPrice && (
                                    <div className="mt-2 flex items-center gap-2 text-xs">
                                      ...
                                      <span className="text-slate-600">
                                        Original: <span className="font-semibold">{originalSymbol}{orderItem.originalPrice.toFixed(2)}</span>
                                      </span>
                                      <span className="text-slate-400">→</span>
                                      <span className="text-slate-600">
                                        Paid: <span className="font-semibold">{orderSymbol}{orderItem.priceAtPurchase.toFixed(2)}</span>
                                      </span>
                                    </div>
                                  )}
                                </div>
                                <div className="text-right">
                                  ...
                                  <div className="font-bold text-slate-800">
                                    {orderSymbol}{(orderItem.priceAtPurchase * orderItem.quantity).toFixed(2)}
                                  </div>
                                  {wasConverted && (
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-200">
                          <div className="flex justify-between items-center mb-2">
                            <span className="text-slate-600 font-medium">Order Currency</span>
                            <span className="flex items-center gap-2 font-bold text-slate-900">
                              {orderCurrency === "INR" ? <RupeeIcon className="w-4 h-4" /> : <DollarIcon className="w-4 h-4" />}
                              {orderCurrency}
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
