...
const CustomDropdown = ({
    ...
    return (
        <div ref={ref} className="relative w-full sm:w-auto sm:min-w-[200px]">
            ...
            >
                <span className={`${value} ? "text-gray-800" : "text-gray-700" dark:text-white`} >{selectedLabel}</span>
            ...
            {open && (
                <div className="absolute z-50 mt-2 w-full bg-white dark:bg-slate-900 border border-gray-100 rounded-2xl shadow-2xl overflow-hidden">
                        ...
                        <div className="flex-1 min-w-[200px]">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-5 py-3 pl-12 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-400 focus:border-blue-400 focus:outline-none transition-all duration-200 text-gray-700 dark:text-gray-200 dark:bg-slate-900 placeholder-gray-400 dark:placeholder-gray-200 text-sm"
                                />
                ...
                {filteredItems.length === 0 ? (
                    ...
                    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {filteredItems.map((item) => {
                            ...
                            return (
                                <div key={item.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden group flex flex-col">
