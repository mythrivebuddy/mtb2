...
// import { Button } from '@/components/ui/button';
// import { BuddyLensRequest } from '@/types/claim';
// import { Eye, Send, Star, LinkIcon, FileQuestion, CloudCog } from 'lucide-react';
// import { NotificationBell } from '@/components/notification-bell';
...
//     setIsLoading(true);
//     try {
//       await axios.patch('/api/buddy-lens/reviewer', { requestId, reviewerId: userId });
...
//   const handleClaimAction = async (requestId: string, action: 'APPROVE' | 'REJECT') => {
//     setIsLoading(true);
//     try {
//       const reviewerId = requests.find((req) => req.id === requestId)?.pendingReviewerId;
//       if (!reviewerId) {
//         throw new Error('No pending reviewer found');
//       }
//       await axios.patch('/api/buddy-lens/approve', {
//         requestId,
//         reviewerId,
//         approve: action === 'APPROVE',
//       });
//       console.log("Id:",requestId,reviewerId);
//       toast.success(`Claim ${action.toLowerCase()}d successfully`);
//       setRequests(
//         requests.map((req) =>
//           req.id === requestId
//             ? action === 'APPROVE'
//               ? { ...req, status: 'CLAIMED', reviewerId: req.pendingReviewerId, pendingReviewerId: null }
//               : { ...req, status: 'OPEN', pendingReviewerId: null }
//             : req
//         )
//       );
...
//   if (!userId) {
//     return <div>Please log in to access the BuddyLens Dashboard.</div>;
//   }
