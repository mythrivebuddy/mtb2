...
//             {[...Array(5)].map((_, i) => (
//               <div key={i} className="bg-white border border-slate-100 p-4 rounded-xl flex items-center justify-between">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <div className="bg-white border border-slate-100 rounded-[24px] p-6 shadow-sm space-y-5">
              ...
              <div className="pt-5 border-t border-slate-50 flex items-center justify-between">
                ...
                <Link 
                // href={`/dashboard/mini-mastery-programs/program/${program.id}`} 
