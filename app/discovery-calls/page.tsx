...
const DiscoveryCallMarketplaceContent = () => {
  return (
    <AppLayout>
      <main>
        ...
        <section className="py-12 bg-background-light rounded-2xl dark:bg-background-dark">
          <div className="container mx-auto px-4 max-w-3xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-black tracking-tight text-slate-900 dark:text-white">
              Discovery Calls — Coming Soon
            </h1>
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
              Soon, you'll be able to browse upcoming growth Discovery Calls
              with coaches, experts, and creators around the world — even if
              they're not yet on MyThriveBuddy.
            </p>
        ...
        <div className="mt-1 rounded-2xl border border-dashed border-slate-300 bg-white/60 p-8 text-center dark:border-slate-700 dark:bg-slate-800/60">
          ...
          <p className="mt-3 text-sm text-slate-600 dark:text-slate-400">
            Get featured at the top, receive more discovery call bookings, and
          ...
          <div className="mt-5 flex flex-col sm:flex-row  sm:justify-center gap-3">
            ...
            <Link
              href="/book-discovery-calls"
              target="_blank"
              className="inline-flex items-center gap-2 rounded-lg h-11 border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 hover:border-brand hover:text-brand transition-colors ease-in-out dark:border-slate-600 dark:bg-slate-900 dark:text-slate-200"
            >
