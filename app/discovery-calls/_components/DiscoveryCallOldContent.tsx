...
export default function DiscoveryCallOldContent() {
  return (
    <>
        {/* Hero + Intro */}
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-16 rounded-2xl border border-dashed border-slate-300 bg-white/60 p-8 text-center dark:border-slate-700 dark:bg-slate-800/60">
              ...
              <div className="mt-5 flex flex-col sm:flex-row  sm:justify-center gap-3">
                <Link href={`/signup?user-type=coach-solopreneur`} className="inline-flex items-center gap-2 rounded-lg h-11 bg-brand px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand/90">
