          ...
          <div className="mt-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Discover insights, stories, and tips from successful solopreneurs in our community
              </p>
            </div>
...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Learn the key strategies that successful solopreneurs use to build and grow their businesses.",
  ...
  },
  {
    ...
    excerpt: "Discover how to maintain a healthy work-life balance while running your solo business.",
  ...
  },
  {
    ...
    excerpt: "Effective marketing strategies that you can implement on your own to grow your business.",
